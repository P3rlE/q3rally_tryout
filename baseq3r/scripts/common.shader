...
// ============================================================
// Q3Rally surface-type physics markers
// Solid + NODRAW: place on (hidden) faces of terrain brushes.
// The car trace hits the brush and returns the surface flag.
// Pattern matches textures/common/slick (which also stays solid).
// ============================================================
...
// ------------------------------------------------------------
// q3r.wet  — wet road / puddle surface
// ------------------------------------------------------------
...
// ------------------------------------------------------------
// q3r.ice  — also inherits Q3 slick physics (zero friction)
// ------------------------------------------------------------
...
// ------------------------------------------------------------
// q3r.metal  — Q3Rally metal surface (not metalsteps footsounds)
// ------------------------------------------------------------

textures/common/metal
{
	qer_trans 0.5
	surfaceparm nodraw
	surfaceparm nolightmap
