...
// Q3Rally Code END
	...
	cgs.media.frontendCharset[RALLY_FONT_ATLAS_512] = trap_R_RegisterShaderNoMip( "gfx/ui/frontend_charset.png" );
	cgs.media.ingameCharset[RALLY_FONT_ATLAS_512] = trap_R_RegisterShaderNoMip( "gfx/ui/ingame_charset.png" );
